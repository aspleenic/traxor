...
class SponsorshipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sponsorship" do
    assert_difference('Sponsorship.count') do
      post sponsorships_url, params: { sponsorship: { direct_cost: @sponsorship.direct_cost, level_label: @sponsorship.level_label } }
    end
  ...
  test "should update sponsorship" do
    patch sponsorship_url(@sponsorship), params: { sponsorship: { direct_cost: @sponsorship.direct_cost, level_label: @sponsorship.level_label } }
